...
<head>
    ...
    <title>Web Compentency - Dashboard</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                @include('dashboard.partials.comment')
            </div>
            <!-- End of Main Content -->
        </div>
        @include("dashboard.components.etc")
    </div>
    <!-- End of Page Wrapper -->
    ...
    <script src="{{ asset("default/js/sb-admin-2.min.js") }}"></script>
    <!-- Page level plugins -->
    <script src="{{ asset("default/vendor/chart.js/Chart.min.js") }}"></script>
    <!-- Page level custom scripts -->
    <script src="{{ asset("default/js/demo/chart-area-demo.js") }}"></script>
    <script src="{{ asset("default/js/demo/chart-pie-demo.js") }}"></script>
</body>
</html>
